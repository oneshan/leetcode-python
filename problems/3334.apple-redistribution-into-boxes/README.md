...
## Metadata
 ...
 - Difficulty: `Easy`
 - Link: https://www.leetcode.com/problems/apple-redistribution-into-boxes
...
- Select boxes greedily until the total capacity is smaller than the total number of apples.
