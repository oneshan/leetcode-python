...
class LeetcodeSync:
    ...
    def __init__(
        ...
        self.last_timestamp: int = LeetcodeSync.get_last_timestamp()
    ...
    def _generate_submission(self, path, submission):
    ...
    def _generate_question_readme(self, path, question):
    ...
    def generate_files(self):
        ...
        for idx, submission in enumerate(self.get_all_submissions(), 1):
            ...
            # Check Language support and update language info into submission
            ...
            if not os.path.exists(f'{path}/README.md'):
                question = self.get_question_info(submission['title_slug'])
        ...
        LeetcodeSync.update_last_timestamp(last_timestamp)
    ...
    @staticmethod
    def update_last_timestamp(timestamp: int) -> None:
